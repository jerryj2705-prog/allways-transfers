  ...
  bookings: router({
    create: publicProcedure.input(
      z2.object({
        ...
        numberOfPets: z2.number().min(1).max(10).nullish(),
        petDescription: z2.string().nullish(),
        // Freight-specific fields
        freightDescription: z2.string().nullish(),
        freightWeight: z2.string().nullish(),
        freightItemCount: z2.number().min(1).max(100).nullish(),
